...
data4 = pd.read_csv('output_wheel_fixed.csv', header=None) #p_wheel_fixed
data5 = pd.read_csv('output_wheel_filter.csv', header=None) #p_wheel_filter
...
x5, y5, z5 = data5.iloc[:, 1], data5.iloc[:, 2], data5.iloc[:, 3]
...
plt.plot(x5,y5, label='output_wheel_filter')
